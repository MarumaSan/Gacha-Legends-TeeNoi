...
class MainLobbyState(GameState):
    ...
    def enter(self):
        ...
        # โหลดภาพพื้นหลัง
        try:
            self.background = assets.load_image('assets/backgrounds/town_1.png', 
        ...
        try:
            self.profile_frame = assets.load_image('assets/ui/profile frame.png')
        except Exception as e:
        ...
        try:
            self.coin_image = assets.load_image('assets/ui/coin.png')
        except Exception as e:
        ...
        try:
            self.profile_image = assets.load_image('assets/ui/profile.png')
        except Exception as e:
        ...
        try:
            self.add_code_image = assets.load_image('assets/ui/add code.png')
        except Exception as e:
    ...
    def _create_buttons(self):
        ...
        try:
            mystic_chest_img = assets.load_image('assets/ui/mystic chest.png', (120, 120))
            celestial_chest_img = assets.load_image('assets/ui/celestial chest.png', (120, 120))
            collection_img = assets.load_image('assets/ui/collection.png', (120, 120))
        except Exception as e:
        ...
        try:
            settings_img = assets.load_image('assets/ui/setting.png', (50, 50))
        except Exception as e:
        ...
        for i, hero_id in enumerate(owned_hero_ids):
            ...
            if hero:
                try:
                    ...
                    original_portrait = assets.load_image(hero.portrait_path)
    ...
    def draw(self, screen):
        ...
        if self.coin_image and self.profile_frame:
            ...
            coin_amount = self.player_data['coins']
