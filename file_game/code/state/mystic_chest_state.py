...
from file_game.code.data.hero_data import get_heroes_by_rarity, get_hero
from file_game.code.ui.animation import CardFlipAnimation
from file_game.code.config import SCREEN_WIDTH, SCREEN_HEIGHT, SUMMON_COSTS, ASSET_PATHS
...
class MysticChestState(GameState):
    ...
    def _create_selection_buttons(self):
        ...
        # โหลดรูปปุ่มสุ่ม
        try:
            summon_x1_img = self.assets.load_image('assets/ui/summon normal1.png')
            summon_x10_img = self.assets.load_image('assets/ui/summon normal10.png')
        except Exception as e:
